...
import { CPUBenchmarkPuppeteer, MemBenchmarkPuppeteer, benchmarks } from "./benchmarksPuppeteer.js";
import { config as defaultConfig, wait, } from "./common.js";
...
export async function executeBenchmark(framework, benchmarkId, benchmarkOptions) {
    ...
    let runBenchmarks = benchmarks.filter((b) => benchmarkId === b.benchmarkInfo.id && (b instanceof CPUBenchmarkPuppeteer || b instanceof MemBenchmarkPuppeteer));
...
process.on("message", (msg) => {
    ...
    defaultConfig.PUPPETEER_WAIT_MS = (_a = benchmarkOptions.puppeteerSleep) !== null && _a !== void 0 ? _a : 0;
...
//# sourceMappingURL=forkedBenchmarkRunnerPuppeteer.js.map