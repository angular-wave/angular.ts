...
(comment
  (def public-type-docs
    ...
    {"js/ng.AnchorScrollProvider" "Public AngularTS AnchorScrollProvider contract exposed through the global ng namespace for Closure-annotated applications."
     ...
     "js/ng.ListenerFn" "Public watcher callback shape. The first argument is the resolved watched value. The second argument is the original target object used when the watcher was registered."
