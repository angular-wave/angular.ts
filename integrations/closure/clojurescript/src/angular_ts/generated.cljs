...
(def public-type-tags
  ...
  #{"js/ng.AnchorScrollProvider"
    ...
    "js/ng.MachineTransitionDefinition"
    "js/ng.MachineTransitionDescriptor"
...
(comment
  (def public-type-docs
    ...
    {"js/ng.AnchorScrollProvider" "Public AngularTS AnchorScrollProvider contract exposed through the global ng namespace for Closure-annotated applications."
     ...
     "js/ng.MachineGuard" "Public AngularTS MachineGuard contract exposed through the global ng namespace for Closure-annotated applications."
     ...
     "js/ng.MachineTransitionDefinition" "Public AngularTS MachineTransitionDefinition contract exposed through the global ng namespace for Closure-annotated applications."
     "js/ng.MachineTransitionDescriptor" "Public AngularTS MachineTransitionDescriptor contract exposed through the global ng namespace for Closure-annotated applications."
