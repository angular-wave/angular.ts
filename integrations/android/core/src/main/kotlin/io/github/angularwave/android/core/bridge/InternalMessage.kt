...
@Serializable
internal data class InternalDataMetadata(@SerialName("metadata") val metadata: InternalMetadata)

@Serializable internal data class InternalMetadata(@SerialName("url") val url: String)
