package io.github.angularwave.android.core.turbo.session
...
import io.github.angularwave.android.core.turbo.errors.LoadError
import io.github.angularwave.android.core.turbo.errors.WebError
import io.github.angularwave.android.core.turbo.errors.WebSslError
import io.github.angularwave.android.core.turbo.http.AngularNativeHttpClient
import io.github.angularwave.android.core.turbo.http.HttpRepository
import io.github.angularwave.android.core.turbo.offline.OfflineHttpRepository
import io.github.angularwave.android.core.turbo.offline.OfflinePreCacheRequest
import io.github.angularwave.android.core.turbo.offline.OfflineRequestHandler
import io.github.angularwave.android.core.turbo.offline.OfflineWebViewRequestInterceptor
import io.github.angularwave.android.core.turbo.util.isHttpGetRequest
import io.github.angularwave.android.core.turbo.util.runOnUiThread
...
class Session(
    ...
    fun preCacheLocation(location: String) {
        val requestHandler = checkNotNull(AngularNative.config.offlineRequestHandler) {
        ...
        offlineHttpRepository.preCache(
            requestHandler, OfflinePreCacheRequest(
                url = location, userAgent = AngularNative.config.userAgentWithWebViewDefault(context)
            )
        )
    }
     ...
     *
     * Some pages intentionally omit AngularNative, and still need full page navigation
