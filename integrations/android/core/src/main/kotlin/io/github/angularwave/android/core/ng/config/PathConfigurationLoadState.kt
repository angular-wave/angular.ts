...
/**
 * Represents the current state of the path configuration loading process. Observe
 * [PathConfiguration.loadState] to receive updates as the configuration is loaded from each source.
 */
sealed interface PathConfigurationLoadState {
    ...
    /**
     * The configuration was successfully loaded from a source. Check the specific subclass to
     * determine the source: [BundledAssetLoaded], [CachedRemoteLoaded], or [RemoteLoaded].
     */
