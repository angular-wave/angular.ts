...
/**
 * Guarantees main thread execution, posting a Runnable on the main Looper if necessary. This allows
 * compatibility with unit tests that are already on the main thread.
 */
