...
import io.github.angularwave.android.core.turbo.config.PathConfiguration.LoaderOptions
...
import io.github.angularwave.android.core.turbo.util.toObject
...
class PathConfigurationTest : BaseRepositoryTest() {
    ...
    private val url = "https://turbo.example.com"
