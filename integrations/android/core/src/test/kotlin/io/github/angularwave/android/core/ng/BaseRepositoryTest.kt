package io.github.angularwave.android.core.ng
...
open class BaseRepositoryTest : BaseUnitTest() {
    ...
    override fun setup() {
        super.setup()
        AngularNativeHttpClient.instance = client()
    ...
    protected fun baseUrl(): String = server.url("/").toString()
    ...
    private fun client(): OkHttpClient =
        OkHttpClient.Builder().dispatcher(Dispatcher(SynchronousExecutorService())).build()

    private fun loadAsset(fileName: String): InputStream =
        javaClass.classLoader?.getResourceAsStream("http-responses/$fileName")
