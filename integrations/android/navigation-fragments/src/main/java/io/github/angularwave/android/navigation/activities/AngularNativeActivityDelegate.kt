...
/**
 * Initializes the Activity for AngularNative navigation and provides all the hooks for an
 * Activity to communicate with AngularNative Native (and vice versa).
 *
