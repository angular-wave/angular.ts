...
abstract class AngularNativeActivity : AppCompatActivity() {
    ...
    /**
     * Provide a list of navigator configurations for the Activity. Configurations for all navigator
     * instances available throughout the app should be provided here.
     */
    abstract fun navigatorConfigurations(): List<NavigatorConfiguration>

    /**
     * Called when a navigator has been initialized and is ready for navigation. The root
     * destination for the navigator has already been created.
     */
