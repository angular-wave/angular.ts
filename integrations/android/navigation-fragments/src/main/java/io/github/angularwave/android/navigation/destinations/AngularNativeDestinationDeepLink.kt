 ...
 *
 * For example:
 *  `@AngularNativeDestinationDeepLink(uri = "angularNative://fragment/search")`
 *  `class SearchFragment : AngularNativeWebFragment()`
 *
...
@MustBeDocumented
annotation class AngularNativeDestinationDeepLink(
    val uri: String
) {
    companion object {
