...
import io.github.angularwave.android.navigation.routing.BrowserTabRouteDecisionHandler
...
internal object AngularNativeNavigation {
    ...
    var registeredBridgeComponentFactories: List<BridgeComponentFactory<AngularNativeDestination, BridgeComponent<AngularNativeDestination>>>
        get() = AngularNative.config.registeredBridgeComponentFactories as List<BridgeComponentFactory<AngularNativeDestination, BridgeComponent<AngularNativeDestination>>>
        set(value) { AngularNative.config.registeredBridgeComponentFactories = value }
}
 ...
 */
fun AngularNative.registerRouteDecisionHandlers(vararg decisionHandlers: Router.RouteDecisionHandler) {
...
fun AngularNative.registerBridgeComponents(
    vararg factories: BridgeComponentFactory<AngularNativeDestination, BridgeComponent<AngularNativeDestination>>
) {
...
var AngularNative.defaultFragmentDestination: KClass<out Fragment>
    ...
    set(value) { AngularNativeNavigation.defaultFragmentDestination = value }
