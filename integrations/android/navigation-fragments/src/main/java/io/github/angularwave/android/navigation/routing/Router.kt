...
/**
 * Routes location urls within in-app navigation or with custom behaviors provided in
 * [RouteDecisionHandler] instances.
 */
class Router(private val decisionHandlers: List<RouteDecisionHandler>) {
    /**
     * An interface to implement to provide custom route decision handling behaviors in your app.
     */
    interface RouteDecisionHandler {
        ...
        /**
         * Determines whether the location matches this decision handler. Use your own custom rules
         * based on the location's domain, protocol, path, or any other factors.
         */
        fun matches(
            location: String,
        ...
        /**
         * Handle custom routing behavior when a match is found. To continue with in-app navigation,
         * return [Decision.NAVIGATE]. To prevent in-app navigation return [Decision.CANCEL].
         */
        fun handle(
            location: String,
            configuration: NavigatorConfiguration,
