...
| `DirectiveCompileFn` | not-applicable |
| `DirectiveFactoryFn` | not-applicable |
| `DirectiveLinkFn` | not-applicable |
| `DirectivePrePost` | not-applicable |
...
| `NativeCallMessage` | deferred |
| `NativeCallOptions` | deferred |
| `NativeConfig` | deferred |
| `NativeEventHandler` | deferred |
| `NativeEventMessage` | deferred |
| `NativeReplyMessage` | deferred |
| `NativeService` | deferred |
