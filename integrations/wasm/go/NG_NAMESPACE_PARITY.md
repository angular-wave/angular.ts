...
| `ComponentViewPrimitive` | alias |
| `ComponentViewProperties` | covered |
| `ComponentViewPropertyValue` | alias |
| `ComponentViewTag` | covered |
| `ComponentViewTags` | covered |
| `Controller` | covered |
...
| `DirectiveView` | not-applicable |
| `DirectiveViewContext` | not-applicable |
