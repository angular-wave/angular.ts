...
| `ProgrammaticView` | covered |
| `ProgrammaticViewChild` | alias |
| `ProgrammaticViewContext` | covered |
| `ProgrammaticViewPrimitive` | alias |
| `ProgrammaticViewProperties` | covered |
| `ProgrammaticViewPropertyValue` | alias |
| `ProgrammaticViewTag` | covered |
| `ProgrammaticViewTags` | covered |
| `Controller` | covered |
| `Directive` | deferred |
| `DirectiveController` | not-applicable |
| `DirectiveRestrict` | deferred |
| `DirectiveFactory` | deferred |
| `DirectiveFactoryFn` | deferred |
| `DirectiveCompileFn` | deferred |
| `DirectiveLinkFn` | deferred |
| `DirectivePrePost` | deferred |
...
| `NativeBridgeAdapter` | covered |
| `NativeBiometricStatus` | covered |
| `NativeCameraCaptureResult` | covered |
| `NativeCameraStatus` | covered |
| `NativeCapabilityEventMap` | covered |
| `NativeCapabilityEventName` | covered |
| `NativeCapabilityEventPayload` | not-applicable |
| `NativeCapabilityMethodContract` | not-applicable |
| `NativeCapabilityMethodMap` | covered |
| `NativeCapabilityMethodName` | covered |
| `NativeCapabilityName` | covered |
| `NativeCapabilityParameters` | not-applicable |
| `NativeCapabilityResult` | not-applicable |
| `NativeCallMessage` | covered |
| `NativeCallOptions` | covered |
| `NativeClipboardContent` | covered |
| `NativeClipboardWriteParameters` | covered |
| `NativeClipboardWriteResult` | covered |
| `NativeConfig` | covered |
| `NativeConnectivityStatus` | covered |
| `NativeCredentialClearResult` | covered |
| `NativeCredentialCreatePasskeyParameters` | covered |
| `NativeCredentialCreatePasskeyResult` | covered |
| `NativeCredentialCreatePasswordParameters` | covered |
| `NativeCredentialCreatePasswordResult` | covered |
| `NativeCredentialGetParameters` | covered |
| `NativeCredentialResult` | covered |
| `NativeCredentialStatus` | covered |
| `NativeEventHandler` | covered |
| `NativeEventMessage` | covered |
| `NativeFileDescriptor` | covered |
| `NativeFileOpenParameters` | covered |
| `NativeFileOpenResult` | covered |
| `NativeFileStatus` | covered |
| `NativeFileUploadParameters` | covered |
| `NativeFileUploadProgress` | covered |
| `NativeFileUploadResult` | covered |
| `NativeGeolocationPosition` | covered |
| `NativeGeolocationStatus` | covered |
| `NativeHapticParameters` | covered |
| `NativeHapticResult` | covered |
| `NativeIntentParameters` | covered |
| `NativeJsonObject` | covered |
| `NativeJsonPrimitive` | covered |
| `NativeJsonValue` | covered |
| `NativeLifecycleStatus` | covered |
...
| `NativeNavigationRouteParameters` | covered |
| `NativeNavigationRouteResult` | covered |
| `NativeNavigationStatus` | covered |
| `NativeNavigationTransition` | covered |
| `NativeNotificationStatus` | covered |
| `NativeOpenResult` | covered |
| `NativePermissionParameters` | covered |
| `NativePermissionStatus` | covered |
| `NativePlatformStatus` | covered |
| `NativeReplyMessage` | covered |
| `NativeService` | covered |
| `NativeShareParameters` | covered |
| `NativeWindowBounds` | covered |
| `NativeWindowDisplayFeature` | covered |
| `NativeWindowInsets` | covered |
| `NativeWindowStatus` | covered |
