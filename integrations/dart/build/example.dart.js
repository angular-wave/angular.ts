...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ComponentTransclusion: function ComponentTransclusion() {
    },
    NoTransclusion: function NoTransclusion() {
    },
    ...
    inject0(factory, $R) {
      return new A.InjectableFactory(B.List_empty0, new A.inject0_closure(factory), $R._eval$1("InjectableFactory<0>"));
    },
    InjectableFactory: function InjectableFactory(t0, t1, t2) {
      this.tokens = t0;
      this._toJsFunction = t1;
      this.$ti = t2;
    },
    inject0_closure: function inject0_closure(t0) {
      this.factory = t0;
    },
    inject0__closure: function inject0__closure(t0) {
      this.factory = t0;
    },
    AngularTsRuntime: function AngularTsRuntime(t0) {
      this._runtime = t0;
    },
    dartToJs(value) {
      if (value == null)
        return null;
      if (value instanceof A.JsValue)
        return value.value;
      if (type$.JsConvertible._is(value))
        return value.toJsValue$0();
      return value;
    },
    object(values) {
      var t1, t2, _this = {};
      for (t1 = values.get$entries(), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
        t2 = t1.get$current();
        _this[t2.key] = A.dartToJs(t2.value);
      }
      return _this;
    },
    strings(values) {
      ...
      for (t2 = values.length, _i = 0; _i < values.length; values.length === t2 || (0, A.throwConcurrentModificationError)(values), ++_i)
        t1.push(values[_i]);
      return t1;
    },
    callMethod(target, method, arg1, arg2) {
      var t1, _null = null;
      if (arg2 != null)
        return A.JSObjectUnsafeUtilExtension__callMethod(target, method, arg1, arg2, _null, _null);
      t1 = A.JSObjectUnsafeUtilExtension__callMethod(target, method, arg1, _null, _null, _null);
      return t1;
    },
    ...
    main() {
      var args,
        t1 = init.G,
        t2 = type$.List_String,
        t3 = A._asJSObject(A.callMethod(A._asJSObject(t1.angular), "createModule", "counterApp", A.strings(t2._as(B.List_empty)))),
        t4 = type$.Component_JSObject;
      t4 = t4._as(new A.Component('        <button type="button" ng-click="counter.increment()">\n          Count: {{ counter.count }}\n        </button>\n      ', A.inject0(new A.main_closure(), type$.JSObject), "counter", t4));
      args = [];
      args.push(A.dartToJs("counterButton"));
      args.push(A.dartToJs(t4));
      t3.component.apply(t3, args);
      t4 = A._asJSObjectQ(A._asJSObject(t1.document).body);
      t4.toString;
      t3 = t3.name;
      t3 = t3 == null ? null : A._asString(t3);
      t3.toString;
      t3 = A._setArrayType([t3], type$.JSArray_String);
      A._asJSObject(A.callMethod(A._asJSObject(t1.angular), "bootstrap", t4, A.strings(t2._as(t3))));
    },
    CounterController: function CounterController() {
      this.count = 0;
    },
  ...
  A.MapBase.prototype = {
    get$entries() {
      var t1 = A._instanceType(this),
        t2 = t1._eval$1("LinkedHashMapKeysIterable<1>");
      t1 = t1._eval$1("MapEntry<1,2>");
      return A.MappedIterable_MappedIterable(new A.LinkedHashMapKeysIterable(this, t2), t2._bind$1(t1)._eval$1("1(Iterable.E)")._as(new A.MapBase_entries_closure(this)), t2._eval$1("Iterable.E"), t1);
    },
    get$length(_) {
      return this.__js_helper$_length;
    },
  ...
  A.ComponentTransclusion.prototype = {};
  A.NoTransclusion.prototype = {};
  A.Component.prototype = {
    toJsValue$0() {
      var t1 = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.nullable_Object);
      t1.$indexSet(0, "template", this.template);
      t1.$indexSet(0, "controller", this.controller.toAnnotatedArray$0());
      t1.$indexSet(0, "controllerAs", this.controllerAs);
      return A.object(t1);
    },
    $isJsConvertible: 1
  };
  A.InjectableFactory.prototype = {
    toAnnotatedArray$0() {
      var t2, _i, t1 = [];
      for (t2 = this.tokens, _i = 0; false; ++_i)
        t1.push(t2[_i].get$name());
      t1.push(this._toJsFunction.call$0());
      return t1;
    },
    toJsValue$0() {
      return this.toAnnotatedArray$0();
    },
    $isJsConvertible: 1
  };
  A.inject0_closure.prototype = {
    call$0() {
      return A._functionToJS0(new A.inject0__closure(this.factory));
    },
    $signature: 5
  };
  A.inject0__closure.prototype = {
    call$0() {
      return A.dartToJs(this.factory.call$0());
    },
    $signature: 6
  };
  A.AngularTsRuntime.prototype = {
    call$1(invocation) {
      return A._asJSObject(A.callMethod(this._runtime, "call", A._asString(invocation), null));
    }
  };
  A.JsValue.prototype = {};
  A.CounterController.prototype = {
    increment$0() {
      ++this.count;
    }
  };
  A.main_closure.prototype = {
    call$0() {
      return new A.main__closure().call$0();
    },
    $signature: 0
  };
  A.main___closure.prototype = {
    call$0() {
      return this._dartInstance.count;
    },
    $signature: 8
  };
  A.main___closure0.prototype = {
    call$1(_val) {
      this._dartInstance.count = A._asInt(_val);
    },
    $signature: 9
  };
  A.main__closure.prototype = {
    call$0() {
      var _0Mapping,
        _dartInstance = new A.CounterController(),
        t1 = init.G,
        t2 = A._asJSObject(t1.Object),
        _jsExporter = A._asJSObject(t2.create.apply(t2, [null]));
      _jsExporter.increment = A._functionToJS0(_dartInstance.get$increment());
      t2 = A._asJSObject(t1.Object);
      _0Mapping = A._asJSObject(t2.create.apply(t2, [null]));
      _0Mapping.get = A._functionToJS0(new A.main___closure(_dartInstance));
      _0Mapping.set = A._functionToJS1(new A.main___closure0(_dartInstance));
      t1 = A._asJSObject(t1.Object);
      t1.defineProperty.apply(t1, [_jsExporter, "count", _0Mapping]);
      return _jsExporter;
    },
    $signature: 0
  };
  ...
  (function installTearOffs() {
    ...
    _instance_0_u(A.CounterController.prototype, "get$increment", "increment$0", 7);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.Rti, A._FunctionParameters, A._Type, A._SyncStarIterator, A.ListBase, A.MapEntry, A.Null, A.StringBuffer, A.ComponentTransclusion, A.Component, A.InjectableFactory, A.AngularTsRuntime, A.JsValue, A.CounterController]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.MapBase_entries_closure, A.main___closure0]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A.JsLinkedHashMap, A.MapBase);
    _inheritMany(A.EfficientLengthIterable, [A.LinkedHashMapKeysIterable, A.LinkedHashMapEntriesIterable]);
    ...
    _inherit(A.NoTransclusion, A.ComponentTransclusion);
    _inheritMany(A.Closure0Args, [A.inject0_closure, A.inject0__closure, A.main_closure, A.main___closure, A.main__closure]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JsConvertible: findType("JsConvertible"),
...
;
    B.C_NoTransclusion = new A.NoTransclusion();
    B.List_empty = makeConstList([], type$.JSArray_String);
    B.List_empty0 = makeConstList([], A.findType("JSArray<Token<Object?>>"));
    B.Object_empty = {};
    B.Map_empty = new A.ConstantStringMap(B.Object_empty, [], A.findType("ConstantStringMap<String,Binding<Object?>>"));
