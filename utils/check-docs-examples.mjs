...
const knownServices = new Map([
  ...
  ["scope", "Scope"],
  ["$state", "StateService"],
  ["$stateRegistry", "StateRegistryService"],
...
const imports = [
  ...
  'import type { StateRegistryService } from "../../@types/router/state/state-registry";',
  'import type { StateService } from "../../@types/router/state/state-service";',
  ...
  'import type { EventBus } from "../../@types/services/event-bus/event-bus";',
  'import type { SceService } from "../../@types/services/sce/sce";',
  'import type { ServiceWorkerService } from "../../@types/services/service-worker/service-worker";',
