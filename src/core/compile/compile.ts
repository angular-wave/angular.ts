...
function queueAttributeObserverCallback(
  ...
  if (state._paused) {
    state._pending.push(() => {
      if (scope._handler._destroyed) return;
...
type DirectiveRequire = string | string[] | Record<string, string> | undefined;
...
export interface TranscludeFn {
  ...
  /** @internal */
  _slots?: Partial<Record<string | number, TranscludeFn | null>>;
...
export interface BoundTranscludeFn {
  ...
  /** @internal */
  _slots: Partial<Record<string | number, BoundTranscludeFn | null>>;
  /** @internal */
  _boundTransclude?: BoundTranscludeFn;
  /** @internal */
  _state?: unknown;
...
export type CompileTemplateFn = (
  nodeList: TemplatePlanNodeList | null,
...
export type TrackedTemplateNodeList = Node[];
...
export interface PreviousCompileContext {
  ...
  _index?: number;
  /** @internal */
  _parentNodeList?: TrackedTemplateNodeList;
  /** @internal */
  _ctxNodeList?: TrackedTemplateNodeList;
  /** @internal */
...
export interface TransclusionContentPlan {
  ...
  /** @internal */
  _slots: Record<string, DocumentFragment | ChildTranscludeOrLinkFn | null>;
}
...
export interface InternalDirective extends ng.Directive {
  ...
  index?: number;
  /** @internal */
  _bindings?: ParsedDirectiveBindings;
  /** @internal */
  _isolateBindings?: IsolateBindingMap | null;
  /** @internal */
  _isolateScope?: boolean;
  /** @internal */
  _newScope?: boolean;
  /** @internal */
  _originalDirective?: ng.Directive;
  /** @internal */
  ...
  /** @internal */
  _needsCompileAttributeState?: boolean;
...
export type DirectiveDefinitionCache = Partial<
...
export interface TwoWayBindingState {
  /** @internal */
  _attrExpression: unknown;
  /** @internal */
  _attrName: string;
  /** @internal */
  _compare: (left: unknown, right: unknown) => boolean;
  /** @internal */
  _destAny: UnknownRecord;
  /** @internal */
...
export type ContextualLinkFn<TLinkCtx = unknown> = RuntimeCallback & {
  /** @internal */
  _linkCtx?: TLinkCtx;
};

interface ContextualDirectivePrePost<
  TPreLinkCtx = unknown,
  TPostLinkCtx = TPreLinkCtx,
> {
  pre?: RuntimeCallback;
  post?: RuntimeCallback;
  /** @internal */
  _linkCtx?: unknown;
  /** @internal */
...
function readSourceElementAttribute(
  attrs: CompileAttributeState,
  element: Element | Node | null | undefined,
  normalizedName: string,
): string | boolean | undefined {
...
export interface NodeLinkState {
  ...
  _compileNode: Node | Element;
  /** @internal */
  _templateAttrs: CompileAttributeState;
  /** @internal */
...
export interface TemplateLinkPlan {
  ...
  /** @internal */
  _trackedNodeList: TrackedTemplateNodeList | null;
  /** @internal */
  _transcludeFn?: ChildTranscludeOrLinkFn | null;
}
...
type ControllerLifecycleInstance = UnknownRecord & {
  _target?: UnknownRecord;
  onChanges?: RuntimeFunction;
...
export class CompileRegistry {
  ...
  constructor($compileLifecycle: CompileLifecycleSink) {
    ...
    const normalizedDirectiveNameCache: Partial<Record<string, string>> =
      nullObject();
    ...
    function parseDirectiveBindings(
      ...
      if (isNonNullDirectiveObject(directive.scope)) {
      ...
      if (isNonNullDirectiveObject(directive.bindToController)) {
        bindings._bindToController = parseIsolateBindings(
    ...
    function sanitizeProgrammaticProperty(
      $injector: ng.InjectorService,
      element: Element,
      propertyName: string,
      value: unknown,
      ...
      for (let index = 0; index < factories.length; index++) {
        try {
          ...
          if (normalizedDirective.view) {
            if (
              normalizedDirective.template !== undefined ||
              normalizedDirective.templateUrl !== undefined
            ) {
              throw $compileError(
                "multiview",
                "Directive '{0}' cannot define view together with template or templateUrl.",
                name,
              );
            }
            ...
            if (normalizedDirective.replace) {
              throw $compileError(
                "viewreplace",
                "Programmatic directive '{0}' cannot use replace.",
                name,
              );
            }
            ...
            const viewCompile = createProgrammaticDirectiveCompile({
              ...
              injector: $injector,
              sanitizeProperty: (element, propertyName, value) =>
                sanitizeProgrammaticProperty(
                  $injector,
                  element,
                  propertyName,
                  value,
            ...
            normalizedDirective.compile = function (...args) {
              const viewLinks = viewCompile.apply(
                this,
                args,
              ) as ng.DirectivePrePost;
              ...
              const pre = function (this: unknown, ...linkArgs: unknown[]) {
                if (viewLinks.pre) Reflect.apply(viewLinks.pre, this, linkArgs);
                if (originalPre) Reflect.apply(originalPre, this, linkArgs);
              };
              const post = function (this: unknown, ...linkArgs: unknown[]) {
                if (viewLinks.post)
                  Reflect.apply(viewLinks.post, this, linkArgs);
                if (originalPost) Reflect.apply(originalPost, this, linkArgs);
              };

              return { pre, post } as unknown as ng.DirectivePrePost;
            };
          }
    ...
    const registerComponent = function registerComponent(
      ...
      if (
        componentOptions.view &&
        (componentOptions.template !== undefined ||
          componentOptions.templateUrl !== undefined)
      ) {
        throw $compileError(
          "multiview",
          "Component '{0}' cannot define view together with template or templateUrl.",
          name,
        );
      }
      ...
      if (componentOptions.view && componentOptions.replace) {
        throw $compileError(
          "viewreplace",
          "Programmatic component '{0}' cannot use replace.",
          name,
        );
      }
      ...
      for (const key in componentOptions) {
        if (key.startsWith("$")) {
          ...
          (factory as unknown as UnknownRecord)[key] = val;

          // Don't try to copy over annotations to named controller
          if (isFunction(controller)) {
            (controller as unknown as UnknownRecord)[key] = val;
          }
        }
      }
      ...
      (
        ...
        async function fetchTemplate(templateUrl: string): Promise<string> {
          return fetch(templateUrl, {
            ...
            if (!response.ok) {
              throw new Error(
                `Failed to fetch template "${templateUrl}": ${String(response.status)} ${response.statusText}`,
              );
            }
        ...
        function triggerDirectiveBindingOnChanges(
          ...
          if (state._destAny.onChanges && state._changes) {
            callFunction(
              state._destAny.onChanges as RuntimeFunction,
              state._destAny,
              state._changes,
            );
          }
        ...
        function removeDirectiveBindingWatches(
          removeWatchCollection: ((() => void) | undefined)[],
        ): void {
        ...
        function handleOneWayBindingChange(
          ...
          const destinationTarget = state._destAny._target as UnknownRecord;
        ...
        function evaluateOneWayBindingInputs(
          ...
          for (let i = 0, l = inputs.length; i < l; i++) {
            values[i] = callFunction(
              inputs[i] as RuntimeFunction,
              undefined,
              state._scopeTarget,
            );
          }
        ...
        function snapshotNodeList(nodes: NodeList): Node[] {
          ...
          const snapshot = new Array<Node>(length);
        ...
        function setTrackedNodeAt(
          ...
          if (index !== undefined) {
            if (index < nodes.length) {
              ...
              nodes[0] = node as Node;
            }
          }
        }

        function createEmptyCompileAttributeState(): CompileAttributeState {
        ...
        function compileTemplate(
          nodeList: Parameters<CompileTemplateFn>[0],
        ...
        function planTemplate(
          ...
          for (let i = 0, l = getTemplateNodeCount(nodeList); i < l; i++) {
            ...
            let attrs: CompileAttributeState | undefined;
        ...
        function createTemplateLinkPlan(
          nodeList: TrackedTemplateNodeList | null,
          transcludeFn?: ChildTranscludeOrLinkFn,
        ): TemplateLinkPlan {
          return {
            _nodeIndices: [],
        ...
        function createNodePreviousCompileContext(
          ...
          index: number,
          trackedTemplateNodeList: TrackedTemplateNodeList | null,
        ): PreviousCompileContext {
        ...
        function collectDirectiveMatches(
          ...
          attrs: CompileAttributeState | undefined,
          maxPriority?: number,
          ignoreDirective?: string,
        ): DirectiveMatchList {
        ...
        function collectElementDirectiveMatches(
          ...
          maxPriority?: number,
          ignoreDirective?: string,
        ): CompileAttributeState | undefined {
        ...
        function collectAttributeDirectiveMatch(
          ...
          if (
            ...
            attrs = createCompileAttributeStateWithPrecedingValues(
              node,
              nodeAttributes,
              attrIndex,
            );
        ...
        function createCompileAttributeStateWithPrecedingValues(
          node: Element,
          nodeAttributes: NamedNodeMap,
          attrIndex: number,
        ...
        function pushLinkFnRecord(
          ...
          linkFn: RuntimeCallback | null | undefined,
        ...
        function handleTextInterpolationWatch(
          ...
          applyTextInterpolationValue(
            bindingState._node,
            String(bindingState._linkState._interpolateFn(bindingState._scope)),
          );
        }
         ...
         */
        function toInterpolatedAttributeValue(
          value: unknown,
        ): InterpolatedAttributeValue {
          if (
            value === null ||
          ...
          if (typeof value === "object" || typeof value === "function") {
            const toStringFn: unknown = Reflect.get(value, "toString");

            if (isFunction(toStringFn)) {
              const stringValue = callFunction(toStringFn, value);
        ...
        function handleAttrInterpolationWatch(
          ...
          const value: unknown = interpolateFn(bindingState._scope);
        ...
        function replayResolvedTemplateNodeLink(
          ...
          if (
            ...
            try {
              if (oldClasses !== "") {
                const { classList } = currentCompileNode as Element;
        ...
        function handleDelayedTemplateLoaded(
          ...
          if (delayedState._origAsyncDirective.replace) {
            ...
            if (delayedState._previousCompileContext._parentNodeList) {
              setTrackedNodeAt(
                delayedState._previousCompileContext._parentNodeList,
                delayedState._previousCompileContext._index,
                compileNode,
              );
            }
            ...
            if (
              isNonNullDirectiveObject(delayedState._origAsyncDirective.scope)
            ) {
          ...
          const delayedContextNodeList: TrackedTemplateNodeList = [compileNode];
          ...
          const afterDirectiveCompileNode = getNodeLinkPlanCompileNode(
            delayedState._afterTemplateNodeLinkPlan,
            compileNode,
          );
        ...
        function executeStoredNodeLinkPlan(
          ...
          if (
            ...
            (nodeLinkState._newIsolateScopeDirective.template ||
              (
                nodeLinkState._newIsolateScopeDirective as unknown as {
                  templateUrl?: unknown;
                }
              ).templateUrl === null)
          ) {
        ...
        function applyInlineTemplateDirective(
          ...
          const templateNodes: Element[] = createDirectiveTemplateNodes(
            directive,
            directiveValue,
          );

          const replacementNode = getSingleElementTemplateRoot(
            templateNodes as ArrayLike<Node>,
            directiveName,
          );
        ...
        function getNodeLinkPlanCompileNode(
          nodeLinkPlan: NodeLinkPlan | undefined,
        ...
        function applyElementTransclusionDirective(
          ...
          const transcludedTemplateElement = templateNode as Element;
        ...
        function applyContentTransclusionDirective(
          ...
          (childTranscludeFn as ng.TranscludeFn)._slots =
            transclusionContentPlan._slots as Partial<
              Record<string | number, TranscludeFn | null>
            >;
        ...
        function resolveDirectiveTemplateValue(
          ...
          const template = isFunction(directive.template)
            ? directive.template(compileNode as HTMLElement)
            : directive.template;
        ...
        function createDirectiveTemplateNodes(
          ...
          return collectElementTemplateNodes(
            typeof wrappedTemplate === "string"
              ? createNodelistFromHTML(wrappedTemplate)
              : wrappedTemplate,
          );
        ...
        function moveChildNodesToFragment(
          compileNode: Node | Element,
        ): DocumentFragment {
          const fragment = createDocumentFragment();
        ...
        function clearMovedTransclusionFragmentData(
          fragment: DocumentFragment,
        ): void {
          const descendants = fragment.querySelectorAll("*");

          for (
            let descendantIndex = 0, descendantCount = descendants.length;
            descendantIndex < descendantCount;
            descendantIndex++
          ) {
            removeElementData(
              descendants[descendantIndex] as Element & UnknownRecord,
            );
          }
        }
        ...
        function createSlotTransclusionContentPlan(
          ...
          const slots = nullObject<DocumentFragment | null>();

          const slotMap = nullObject<string>();

          const filledSlots = nullObject<boolean>();
        ...
        function distributeTransclusionSlots(
          compileNode: Node | Element,
          defaultSlotContent: DocumentFragment,
        ...
        function clearMovedTransclusionSlotData(
          slots: Record<string, DocumentFragment | null>,
        ): void {
        ...
        function hasRemainingTransclusionConflict(
          ...
          for (
            ...
            directive = directives[i++] as InternalDirective | undefined;
            ...
            const linkFn = directive._needsCompileAttributeState
              ? (compileDirective.call(
                  ...
                  ...([
                    ...
                    templateAttrs,
                    childTranscludeFn,
                  ] as unknown as Parameters<typeof compileDirective>),
        ...
        function appendDirectiveLinkResult(
          ...
          const context: unknown = directive._originalDirective ?? directive;
          ...
          const preLinkCtx: unknown = linkFn._preLinkCtx ?? linkFn._linkCtx;

          const postLinkCtx: unknown = linkFn._postLinkCtx ?? linkFn._linkCtx;
        ...
        function setupControllers(
          ...
          for (const controllerKey in _controllerDirectives) {
            ...
            if (controller === "@") {
              controller = readNormalizedElementAttribute(
                node,
                directive.name,
         ...
         */
        function mergeTemplateAttributeState(
          dst: CompileAttributeState,
          src: CompileAttributeState,
          oldNode: Node | Element,
          ...
          for (let i = 0, l = dstKeys.length; i < l; i++) {
            ...
            if (srcValue && srcValue !== value) {
              if (typeof value === "string" && value.length) {
                value += `${key === "style" ? ";" : " "}${
                  typeof srcValue === "string" ? srcValue : stringify(srcValue)
                }`;
              } else {
                value = srcValue;
              }
        ...
        function compileTemplateUrl(
          ...
          if (isFunction(origAsyncDirective.templateUrl)) {
            templateUrl = origAsyncDirective.templateUrl.call(
              origAsyncDirective,
              compileNode as HTMLElement,
            );
          } else {
        ...
        function compilePropertyDirective(
          ...
          const attrExpression = stringify(
            readNormalizedElementAttribute(element, compileState._attrName) ??
              "",
          );
        ...
        function initializeDirectiveBindings(
          ...
          const removeWatchCollection: ((() => void) | undefined)[] = [];
            ...
            for (const scopeName in bindings) {
              ...
              switch (mode) {
                ...
                case "=": {
                  ...
                  removeWatch = destination._handler.watch(
                    attrName,
                    (val) => {
...
function getDirectiveRestrict(
  ...
  return typeof restrict === "string" ? (restrict as DirectiveRestrict) : "EA";
}
...
function replaceWith(
  ...
  if (parent) {
    if (index !== undefined) {
      const oldChild = parent.childNodes[index] as ChildNode | undefined;
