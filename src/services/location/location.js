...
export class Location {
  ...
  /**
   * Angular-style overloaded url accessor.
   *
   * @param {string=} url
  ...
  /**
   * Angular-style overloaded path accessor.
   *
   * @param {(string|number)=} path
   * @return {string|Location}
   */
  path(path) {
    return arguments.length ? this.setPath(path) : this.getPath();
  }
  ...
  /**
   * Angular-style overloaded hash accessor.
   *
   * @param {(string|number)=} hash
   * @return {string|Location}
   */
  hash(hash) {
    return arguments.length ? this.setHash(hash) : this.getHash();
  }
  ...
  /**
   * Angular-style overloaded search accessor.
   *
   * @param {(string|Object)=} search
   * @param {(string|number|Array<string>|boolean)=} paramValue
  ...
  /**
   * Angular-style overloaded state accessor.
   *
   * @param {any=} state
   * @return {any|Location}
   */
