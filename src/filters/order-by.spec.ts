...
describe("Filter: orderBy", () => {
  let orderBy: (...args: any[]) => any;

  let orderByFilter: (...args: any[]) => any;
  ...
  describe("(Arrays)", () => {
    ...
    it("should sort inherited from array", () => {
      ...
      // @ts-expect-error The test intentionally exercises a legacy constructor with Array.prototype.
    ...
    describe("(custom comparator)", () => {
      it("should support a custom comparator", () => {
        ...
        const comparator = function (o1: any, o2: any) {
          const v1 = o1.value;
      ...
      it("should pass `{value, type, index}` objects to comparators", () => {
        ...
        const allArgsFlat = Array.prototype.concat.apply(
          [],
          comparator.calls.allArgs() as any,
        );
    ...
    describe("(object as `value`)", () => {
      ...
      it("should ignore the `toString()` inherited from `Object`", () => {
        ...
        window.toString = originalToString;
      });
