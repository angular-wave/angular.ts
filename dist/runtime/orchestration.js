...
const machineModule = memoizeRuntimeModule((angular) => angular.module("ng.machine", []).factory(_machine, createMachineService));
 ...
 */
const orchestrationModule = memoizeRuntimeModule((angular) => angular.module("ng.orchestration", [
