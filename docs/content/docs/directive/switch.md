...
Conditionally renders one of several templates based on the value of an
expression. Similar to a JavaScript `switch` statement.
...
The value to match against `ng-switch`. The element is rendered when the switch
value equals this.
