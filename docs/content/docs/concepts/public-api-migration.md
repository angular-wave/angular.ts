...
| `ng.InjectorService`                                                                                                                                                | Ordinary apps should use injected runtime services. Advanced runtime/custom-element code may use `angular.injector(...)`, `angular.currentInjector`, lazy state loaders, and web-component contexts. | advanced public           |
