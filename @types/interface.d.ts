...
export declare const PublicInjectionTokens: {
  ...
  readonly $anchorScrollProvider: "$anchorScrollProvider";
  readonly $animateCssProvider: "$animateCssProvider";
  readonly $compileProvider: "$compileProvider";
  readonly $animateProvider: "$animateProvider";
  readonly $ariaProvider: "$ariaProvider";
  readonly $cookieProvider: "$cookieProvider";
  readonly $eventBusProvider: "$eventBusProvider";
  readonly $exceptionHandlerProvider: "$exceptionHandlerProvider";
  readonly $filterProvider: "$filterProvider";
  readonly $httpProvider: "$httpProvider";
  readonly $httpParamSerializerProvider: "$httpParamSerializerProvider";
  readonly $interpolateProvider: "$interpolateProvider";
  readonly $locationProvider: "$locationProvider";
  readonly $logProvider: "$logProvider";
  readonly $parseProvider: "$parseProvider";
  readonly $restProvider: "$restProvider";
  readonly $rootScopeProvider: "$rootScopeProvider";
  readonly $routerProvider: "$routerProvider";
  readonly $sceProvider: "$sceProvider";
  readonly $sceDelegateProvider: "$sceDelegateProvider";
  readonly $sseProvider: "$sseProvider";
  readonly $stateProvider: "$stateProvider";
  readonly $stateRegistryProvider: "$stateRegistryProvider";
  readonly $templateCacheProvider: "$templateCacheProvider";
  readonly $templateFactoryProvider: "$templateFactoryProvider";
  readonly $templateRequestProvider: "$templateRequestProvider";
  readonly $transitionsProvider: "$transitionsProvider";
  readonly $urlConfigProvider: "$urlConfigProvider";
  readonly $urlProvider: "$urlProvider";
  readonly $viewProvider: "$viewProvider";
