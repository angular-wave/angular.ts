 ...
 */
export declare function urlResolve(url: ResolvableUrl): ParsedUrl;
/**
 ...
 */
export declare function urlIsSameOrigin(requestUrl: ResolvableUrl): boolean;
/**
 ...
 */
export declare function urlIsSameOriginAsBaseUrl(
  requestUrl: ResolvableUrl,
): boolean;
/**
 ...
 */
export declare function urlIsAllowedOriginFactory(
 ...
 */
export declare function urlsAreSameOrigin(
  url1: ResolvableUrl,
  url2: ResolvableUrl,
): boolean;
/**
 ...
 * @returns {string}
 */
export declare function trimEmptyHash(url: string): string;
